...
export default function Insights() {
  const iframeUrl = env.insightsAppUrl
  return (
    <OccurrenceProvider>
            ...
            <div className="space-y-4">
              <div className="rounded-xl border border-border bg-card p-4 shadow-sm">
                <p className="text-sm text-muted-foreground">
                  A aba Insights está carregando o aplicativo dedicado em um serviço isolado. Os dados continuam sendo compartilhados com o mesmo banco "ocorrencias_portoex".
                </p>
                <p className="text-xs text-muted-foreground">Carregando: {new URL(iframeUrl).href}</p>
              </div>
              <div className="h-[80vh] rounded-xl border border-border overflow-hidden shadow-lg">
                <iframe
                  title="PortoEx Insights"
                  src={iframeUrl}
