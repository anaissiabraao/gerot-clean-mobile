...
| 2 | `evento` | `varchar(255)` | YES | `` | `` | `` | `` |
| 3 | `data` | `datetime` | NO | `` | `` | `` | `` |
| 4 | `arquivo` | `varchar(150)` | YES | `` | `` | `` | `` |
| 5 | `operador` | `smallint` | NO | `` | `` | `` | `` |
| 6 | `tipo_log` | `int` | YES | `` | `` | `` | `` |
