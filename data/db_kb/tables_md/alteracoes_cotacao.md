# Tabela `azportoex.alteracoes_cotacao`

## Identificação
- **Banco**: `azportoex`
- **Tabela**: `alteracoes_cotacao`
- **Tipo**: `BASE TABLE`
- **Engine**: `InnoDB`
- **Collation**: `utf8mb4_unicode_ci`
- **Registros (estimativa)**: `259921`
- **Create time**: `2025-09-07T17:36:05`
...
- `nao_classificado`, `alteracoes`, `cotacao`
