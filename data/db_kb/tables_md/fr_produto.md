...
| 3 | `descricao` | `varchar(255)` | YES | `` | `` | `` | `` |
| 4 | `status` | `int` | YES | `1` | `` | `` | `` |
| 5 | `codigo_externo` | `varchar(20)` | YES | `` | `` | `` | `` |
| 6 | `lote` | `varchar(20)` | YES | `` | `` | `` | `` |
| 7 | `tipo` | `int` | YES | `` | `` | `` | `` |
