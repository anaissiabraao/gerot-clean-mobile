# Tabela `azportoex.minutas_prejuizos`

## Identificação
- **Banco**: `azportoex`
- **Tabela**: `minutas_prejuizos`
- **Tipo**: `BASE TABLE`
- **Engine**: `InnoDB`
...
| 2 | `id_minuta` | `int` | NO | `` | `` | `` | `` |
| 3 | `tipo_prejuizo` | `int` | NO | `` | `` | `` | `` |
| 4 | `status` | `varchar(55)` | YES | `1` | `` | `` | `` |
| 5 | `descricao` | `varchar(55)` | YES | `` | `` | `` | `` |
| 6 | `motivo` | `varchar(55)` | YES | `` | `` | `` | `` |
...
- `nao_classificado`, `minutas`, `prejuizos`
