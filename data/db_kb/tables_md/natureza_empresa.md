# Tabela `azportoex.natureza_empresa`

## Identificação
- **Banco**: `azportoex`
- **Tabela**: `natureza_empresa`
- **Tipo**: `BASE TABLE`
- **Engine**: `InnoDB`
...
- `cadastros_base`, `natureza`, `empresa`
