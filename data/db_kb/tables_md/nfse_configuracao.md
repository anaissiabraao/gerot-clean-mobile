# Tabela `azportoex.nfse_configuracao`

## Identificação
- **Banco**: `azportoex`
- **Tabela**: `nfse_configuracao`
- **Tipo**: `BASE TABLE`
- **Engine**: `InnoDB`
...
| 2 | `senha` | `varchar(20)` | NO | `` | `` | `` | `` |
| 3 | `ambiente` | `tinyint` | YES | `2` | `` | `` | `` |

## Campos críticos (INFERIDO)
- **IDs prováveis**: `id_unidade`
...
- `fiscal_documentos`, `nfse`, `configuracao`
