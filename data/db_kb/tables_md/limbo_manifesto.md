# Tabela `azportoex.limbo_manifesto`

## Identificação
- **Banco**: `azportoex`
- **Tabela**: `limbo_manifesto`
- **Tipo**: `BASE TABLE`
- **Engine**: `InnoDB`
...
|---:|---|---|---|---|---|---|---|
| 1 | `id_manifesto` | `int` | NO | `` | `` | `` | `` |
| 2 | `valor_antigo` | `varchar(60)` | YES | `` | `` | `` | `` |
| 3 | `valor_novo` | `varchar(60)` | YES | `` | `` | `` | `` |
...
- `operacao_logistica`, `limbo`, `manifesto`
