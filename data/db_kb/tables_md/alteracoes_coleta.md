# Tabela `azportoex.alteracoes_coleta`

## Identificação
- **Banco**: `azportoex`
- **Tabela**: `alteracoes_coleta`
- **Tipo**: `BASE TABLE`
- **Engine**: `InnoDB`
- **Collation**: `utf8mb4_unicode_ci`
- **Registros (estimativa)**: `344621`
...
- `idx_coleta` type=`BTREE` non_unique=`True` cols=[`coleta`]
...
- `nao_classificado`, `alteracoes`, `coleta`
